...
obs_var = 8  # numero di variabili osservate
nl_obs_var = 0  # numero di variabili osservate con relazioni non lineari
...
model = VAE()
model = torch.load("sigm_linear.pt").to(device)
...
plt.savefig("VAE_relation_linear")
plt.show()
